...
import { Wrench, ArrowRight, BarChart3, Package, History, Activity } from 'lucide-react'
...
export default function LoginPage() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (usuario === '' && password === '') {
      setAuth(
        { id: '1', name: 'Usuario Prueba', email: 'prueba@tallerp.com', role: 'admin', companyId: '1', companyName: 'Taller Demo' },
        'mock-token-prueba'
      )
      navigate('/')
    } else {
  ...
  return (
    <div className="w-full min-h-screen overflow-hidden bg-gradient-to-br from-[#0F0A05] via-[#150D06] to-[#1A1008] text-white relative flex">

      {/* Ambient glows — naranja */}
      <div className="absolute top-[-200px] right-[-200px] w-[500px] h-[500px] rounded-full bg-orange-500/10 blur-[140px] pointer-events-none" />
      <div className="absolute bottom-[-200px] left-[-200px] w-[500px] h-[500px] rounded-full bg-orange-600/8 blur-[140px] pointer-events-none" />

      {/* LEFT PANEL */}
      <section className="hidden lg:flex lg:w-[55%] relative overflow-hidden border-r border-white/5 bg-[#110B04]">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-16 py-20 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-5 mb-14">
            {features.map(({ title, icon: Icon }) => (
              <div
                key={title}
                className="rounded-2xl border border-white/8 bg-white/[0.04] backdrop-blur-xl p-5 transition-all duration-300 hover:border-orange-400/20 hover:bg-white/[0.06]"
              >
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-orange-400/10 border border-orange-400/15">
      ...
      <section className="flex flex-1 items-center justify-center px-6 py-10 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center mb-10">
            <div className="mb-5 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-orange-500 to-orange-600 shadow-[0_0_50px_rgba(249,115,22,0.40)]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="prueba"
                  className="w-full rounded-2xl border border-white/10 bg-white/[0.07] px-4 py-4 text-white placeholder:text-slate-500 outline-none transition-all duration-300 focus:border-orange-400/40 focus:bg-white/[0.09] focus:ring-4 focus:ring-orange-400/10"
                />
              </div>
              ...
              <button
                type="submit"
                className="group mt-2 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 px-4 py-4 font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(249,115,22,0.40)] active:scale-[0.99]"
              >
                Entrar
              ...
              <p className="text-center text-xs text-slate-500 pt-1">
                Acceso de prueba: deja los campos vacíos y presiona Entrar
              </p>

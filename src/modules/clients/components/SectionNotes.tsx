...
export function SectionNotes() {
  const { register, watch } = useFormContext<ClientFormValues>()
  const notes = watch('notes') ?? ''

  return (
    <ClientSectionCard icon={StickyNote} title="Notas internas" subtitle="Observaciones visibles solo para el equipo">
      <div className="mt-5">
        <textarea
          {...register('notes')}
          rows={4}
          placeholder="Ej: Cliente frecuente, prefiere citas por la mañana. Facturación mensual. No llamar después de las 7pm."
